            ...
            <div className="top-line">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-2 col-md-2 font-14 d-flex">
                            <span className="mr-2"> <a href="https://www.facebook.com/" target="_blank" className="socialIcon"><i className="fab fa-facebook-f black font-14 mt-1"></i></a></span>
                            <span className="mr-2"> <a href="https://www.instagram.com/" className="socialIcon" target="_blank"><i className="fab fa-instagram black font-14 mt-1"></i></a></span>
                            <span className="mr-2"> <a href="https://in.linkedin.com/" className="socialIcon" target="_blank"><i className="fab fa-linkedin-in black font-14 mt-1"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <img src='../images/ivision_logo.png' />
                        ...
                        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                            ...
                            <Link to="/contact/" className="nav-item nav-link mr-3">Contact</Link>
                            </div>
                        </div>
                    </nav>                 
                </div>   
